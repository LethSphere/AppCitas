...
export class EliminarPacienteComponent implements OnInit{
  ...
  BuscarPaciente(){
    this.pacienteService.ObtenerPacientePorId(this.id).subscribe((datos:ModeloPaciente)=>{
...
EliminarPaciente(){
  ...
  this.pacienteService.EliminarPaciente(this.id).subscribe((response:string)=>{
