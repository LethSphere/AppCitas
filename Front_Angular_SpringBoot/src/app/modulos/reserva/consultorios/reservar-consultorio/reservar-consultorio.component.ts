...
//se usa .padStart para completar el formato de dos digitos que solicita el backend
  ...
  public confirmarReservaConsultorio():void{
    ...
    console.log(this.consultorioLibreSeleccionado)
    console.log(this.fechaInicioSeleccionada)
    console.log(this.fechaFinSeleccionada)

    let idDoctor=this.doctorGuardado?.id;
