...
@Component({
  selector: 'app-buscar-citas-medicas-paciente',
  templateUrl: './buscar-citas-medicas-paciente.component.html',
  styleUrls: ['./buscar-citas-medicas-paciente.component.css']
})
export class BuscarCitasMedicasPacienteComponent implements OnInit {
  id:string ='';
  ...
  obtenerListadoCitasMedicas(){
    this.citasMedicasService.obtenerCitasMedicasporPaciente(this.id).subscribe(
